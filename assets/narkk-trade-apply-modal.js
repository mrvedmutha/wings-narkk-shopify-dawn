(function () {
  ...
  /* Scroll inside the modal is native — .narkk-tam__panel carries
     data-lenis-prevent so the sitewide Lenis smooth-scroll library
     leaves it alone, and overflow-y/-webkit-overflow-scrolling/
     overscroll-behavior (in the CSS) handle the rest, same pattern
     as the filter drawer. No manual wheel/touch handling needed. */
