...
| 28 | 2026-06-12 | All pages | Logo — Nav, Drawer, Footer | Replaced `narkk-logo-black-new.svg` with new `narkk-logo-black-updated.svg` across header (nav + drawer) and footer | `sections/narkk-header.liquid`, `sections/narkk-footer.liquid`, `assets/narkk-logo-black-updated.svg` |
